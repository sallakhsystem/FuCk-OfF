...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add me, follow my instagram @s1_1366",
    "lang":"JP",
    "comment":"Thanks for add me, follow my instagram @s1_1366",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u9e7d8fa4b0465a713cdabfbfab21e35d":
                    if "join:" in msg.text:
